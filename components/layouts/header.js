              ...
              <div className="relative flex items-center justify-between h-16">
                        ...
                        <a
                          ...
                          className={classNames(
                            item.href === router.pathname
                              ...
                              : "",
                            `px-3 py-2 rounded-md cursor-pointer text-base font-base hover:text-sky-700 hover:scale-110`,
                            `${
                              theme === "light"
                                ? "text-sky-600"
                                : "text-sky-100"
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  <button
                    ...
                    className={`${
                      theme === "light" ? "fill-sky-500" : "fill-gray-200"
                    } hidden sm:block hover:scale-110 hover:fill-purple-400`}
                  >
                    {icon}
                  </button>
                    ...
                    <Menu as="div" className="mx-2 relative">
                      <Menu.Button className="dark:bg-gray-600 bg-slate-200 px-2 py-1 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                        <Link
                          ...
                          passHref
                        >
                          <a className="flex items-center justify-center text-center cursor-pointer shadow-slate-400  sm:static sm:inset-auto sm:mx-2">
                            <span className="text-base hover:underline text-sky-600 decoration-green-400 underline-2 underline-offset-4">
                              {t("loginBtn")}
                            </span>
                          </a>
                        </Link>
            ...
            <Disclosure.Panel className="sm:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <button
                  ...
                  onClick={() =>
                    router.push(router.pathname, router.pathname, {
                      locale: router.locales.find((f) => f !== router.locale),
                    })
                  }
                >
                  <span className="sr-only">Switch language</span>
                ...
                <button
                  ...
                  className={`${
                    theme === "light" ? "fill-sky-500" : "fill-gray-200"
                  } mx-3 flex hover:scale-110 hover:fill-purple-400`}
                >
