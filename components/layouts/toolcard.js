...
export const ToolCard = ({ tool }) => {
  return (
    <div id={tool.id} tabIndex={tool.index}
      className="h-48 ring-1 focus:ring-sky-900 dark:ring-sky-200 focus:dark:ring-orange-600
    ...
    >
      ...
      {tool.pic&&<div className=""><img src={tool.pic} className="h-16" alt="pic"></img></div>}
    </div>
  );
};
