  ...
  return (
    <>
      <p className="text-2xl font-medium text-center">
        {id ? "Edit your blog" : "Create your new blog"}
      </p>
      <div className="flex flex-col">
        ...
        <label className="text-xl mb-2">
          Main content
          <span className="text-sm">(title not neccessary to repeat)</span>
          <span
            className=" cursor-pointer text-sm text-orange-400 mx-4"
            onClick={() => window.scrollTo(0, preview?.current.offsetTop || 0)}
          >
            check preview
          </span>
        </label>
        ...
        <div className="flex">
          <button
            className="mt-10 w-36 lg:w-48 btn-secondary mx-auto"
            onClick={clearAction}
          >
            Clear
          </button>
          <button
            onClick={async (e) => await handleArticle(e)}
      ...
      <div className="h-64 mt-20 container mx-auto">
        <div className="text-2xl font-medium text-center" ref={preview}>
          Preview mode
        </div>
