...
export const SearchElement=()=>{
    ...
    return (
        ...
        <div className="absolute inset-y-0 left-1 pl-3 flex items-center pointer-events-none">
          <span className="text-gray-200 text-sm"><SearchIcon/></span>
        </div>
        <input
          type="text"
          name="price"
...
const SearchIcon=()=>{
    return (
        <svg t="1643554468663" className="h-4 w-4 fill-slate-300" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1241" width="20" height="20">
